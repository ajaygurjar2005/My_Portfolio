  ...
  const handleSearch = async (event) => {
    ...
    try {
      ...
      if (response.data.data == null) {
        setStoreUsers((results.length = 0));
      } else {
        setStoreUsers([response.data.data]);
                  ...
                  {storeUsers.length > 0 ? (
                    storeUsers.map((data) => (
                      <tr key={data._id}>
                        ...
                        <td className="px-6 py-4 text-sm font-medium leading-5 text-right whitespace-no-wrap border-b border-gray-200 text-[20px]">
                          <Link to={"/admin/edituser"}>
                            <button
                              onClick={() => editData(data._id)} // Assuming deleteUser is a function to delete a user
                          ...
                          <button
                            onClick={() => deleteUser(data._id)} // Assuming deleteUser is a function to delete a user
                    ...
                    <tr>
                      <td
                        colSpan="6"
                        className="px-6 py-4 text-sm leading-5 text-gray-500 border-b border-gray-200"
                      >
                        No results found
                      </td>
                    </tr>
