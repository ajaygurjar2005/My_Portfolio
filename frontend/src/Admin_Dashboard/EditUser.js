...
useEffect(()=>{
      ...
      const response = axios
        ...
        .then((succes) => {
          ...
          setStorevalues(succes.data.data);
        })
        .catch((err) => {
          console.log(err);
        });
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="more-info">
                            <p className="lead" style={{ fontSize: "16px" }}>
                              ...
                              elit. Facilis dolorum dolorem soluta quidem
                              expedita aperiam aliquid at. Totam magni ipsum
                              suscipit amet? Autem nemo esse laboriosam ratione
                            ...
                            >
                              <li>
                                <span className="bi bi-geo-alt" /> Sewapura ,
                                Jaipur
                              </li>
                              <li>
